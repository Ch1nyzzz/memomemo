...
% \usepackage{dsfont}           % Unused; omitted to avoid extra TeX dependency.
...
\usepackage{makecell}
% \usepackage{nicematrix}       % Unused; omitted to avoid extra TeX dependency.
...
% ======== 算法 ========
% Avoid optional algorithm packages; pseudocode is typeset with standard boxes.
